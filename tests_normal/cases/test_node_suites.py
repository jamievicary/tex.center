...
class TestNodeSuites(unittest.TestCase):
    ...
    def test_sidecar_server_dirty_page(self) -> None:
        _run_tsx(ROOT / "apps" / "sidecar" / "test" / "serverDirtyPage.test.mjs")
    ...
    def test_sidecar_idle_suspend(self) -> None:
        _run_tsx(ROOT / "apps" / "sidecar" / "test" / "idleSuspend.test.mjs")
    ...
    def test_sidecar_server_observe_mirror(self) -> None:
        _run_tsx(ROOT / "apps" / "sidecar" / "test" / "serverObserveMirror.test.mjs")
    ...
    def test_web_pdf_cross_fade(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "pdfCrossFade.test.mjs")
    ...
    def test_web_session_sweep(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "sessionSweep.test.mjs")
    ...
    def test_web_file_tree_keyboard(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "fileTreeKeyboard.test.mjs")

    def test_web_file_tree_context_menu(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "fileTreeContextMenu.test.mjs")
    ...
    def test_web_ws_client_decode_error(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "wsClientDecodeError.test.mjs")
    ...
    def test_web_ws_client_dirty_page(self) -> None:
        _run_tsx(ROOT / "apps" / "web" / "test" / "wsClientDirtyPage.test.mjs")
